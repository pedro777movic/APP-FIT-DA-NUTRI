...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    imagem: 'breakfast-4',
    ingredientes: [
      '1 xícara de cascas e talos de vegetais (cenoura, abobrinha, brócolis) bem picados',
      '1 ovo',
  ...
  },
  {
    ...
    imagem: 'cake-27',
    ingredientes: [
      'Massa: 1 ovo, 2 colheres de sopa de xilitol, 3 colheres de sopa de farinha de aveia, 3 colheres de sopa de leite, 1/2 colher de chá de fermento',
      'Creme: 150g de ricota, 150g de cream cheese light, 2 colheres de sopa de xilitol, baunilha',
      'Montagem: Café forte sem açúcar, cacau em pó para polvilhar',
    ],
  ...
  {
    id: 'quibe-vegano-abobora-quinoa',
